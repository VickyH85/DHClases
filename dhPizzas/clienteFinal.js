...
inquirer
	...
	.then(function (respuestas) {
		...
		//.toLowerCase() sirve para pasar a minuscula
		...
		//Las comillas como tilde invertido, da un string pero si las variables las pongo entre
		//{} y con un $ adelante las toma con el valor de variable.
		//para que aparezca el signo $ pongo doble $${}
		...
		//Agregando al objeto respuestas varias props
		respuestas.totalPedido = precioFinal;
		respuestas.descuento = descuento;

		//Ruta de archivo pedidos
